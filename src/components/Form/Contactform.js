...
/*const Form = ({user, handleChange, handleSubmit, success, error}) =>{
    ...
    return(
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <textarea  value={user.message} onChange={handleChange} name="message" placeholder="Dejanos tu mensaje..."/><br/>
